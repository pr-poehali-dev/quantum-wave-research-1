  ...
  return (
    <div className="h-screen bg-black relative overflow-hidden">
      <div
        ...
        style={{ backgroundImage: "url('https://cdn.poehali.dev/projects/6dd03886-b06c-426e-a600-cc9708ce98e9/files/4f400cbf-dbc5-4a6b-8a50-8cab7b4d294f.jpg')" }}
      />
      ...
      <div className="h-screen uppercase items-center w-full absolute z-[60] px-10 flex justify-center flex-col">
        ...
        <div
          className={subtitleVisible ? "fade-in-subtitle mt-8" : "mt-8"}
          style={{
